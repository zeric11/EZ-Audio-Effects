...
struct Fifo
{
    ...
    {
        static_assert(
            std::is_same_v<T, juce::AudioBuffer<float>>,
...
/**
*/
class EZAudioEffectsAudioProcessor : public juce::AudioProcessor
{
public:
    //==============================================================================
    EZAudioEffectsAudioProcessor();
    ~EZAudioEffectsAudioProcessor() override;
